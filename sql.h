...
#define CREATE_TB "CREATE TABLE users (user_name varchar(255) NOT NULL PRIMARY KEY, password char NOT NULL, user_id varchar(255) NOT NULL, group_id varchar(255) NOT NULL, comments char NOT NULL, home_path varchar(255) NOT NULL, path_to_interpretator varchar(255) NOT NULL);"
